          ...
          >
            <Link href="/">
              {logoSrc ? (
                ...
                <div className="h-10 w-10 bg-blue-500 rounded-full flex items-center justify-center text-white font-bold">IA</div>
              )}
            </Link>
          </motion.div>
          <Link href="/" className="text-xl font-bold text-white hover:text-blue-400 transition duration-200">
            {title}
          </Link>
        </div>
        ...
        <div className="flex items-center space-x-4">
          ...
          >
            <Avatar className="border-2 border-blue-500">
              ...
              <AvatarFallback className="bg-slate-700 text-white">{userName.substring(0, 2).toUpperCase()}</AvatarFallback>
            </Avatar>
          </motion.div>
          ...
          <div className="px-4 py-3 space-y-1 bg-slate-900 border-t border-slate-800">
            {menuItems.map((item, index) => (
              <div key={index}>
                {item.children ? (
                  <div>
                    <div className="text-white font-medium py-2">{item.title}</div>
