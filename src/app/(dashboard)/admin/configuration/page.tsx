...
const configMetadata: ConfigMetadata = {
  'session_timeout_minutes': {
    ...
    description: 'Number of minutes of inactivity before a user is automatically logged out.',
    type: 'number',
  },
  ...
  'ip_block_duration_hours': {
    ...
    description: 'Number of hours an IP address remains blocked after exceeding the failed login attempts limit.',
    type: 'number',
  },
  'password_min_length': {
  ...
  'system_maintenance_mode': {
    ...
    description: 'Enable maintenance mode to restrict access to admin users only.',
    type: 'boolean',
  },
