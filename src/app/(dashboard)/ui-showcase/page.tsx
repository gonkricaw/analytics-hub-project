...
export default function UIShowcasePage() {
  ...
  const carouselItems = [
    <div key="1" className="h-64 bg-blue-600 rounded-xl flex items-center justify-center text-white font-bold text-xl">Slide 1</div>,
    <div key="2" className="h-64 bg-purple-600 rounded-xl flex items-center justify-center text-white font-bold text-xl">Slide 2</div>,
    <div key="3" className="h-64 bg-green-600 rounded-xl flex items-center justify-center text-white font-bold text-xl">Slide 3</div>,
  ];
  ...
  return (
    <div className="container mx-auto p-8">
      ...
      <section className="mb-12">
        <Marquee>
          <div className="mr-8">Welcome to Indonet Analytics Hub UI Component Showcase</div>
          <div className="mr-8">Explore our beautiful UI components</div>
          <div className="mr-8">Built with Next.js, Tailwind CSS, shadcn/ui, and Framer Motion</div>
        </Marquee>
      </section>
        ...
        <Card className="shadow-lg hover:shadow-xl transition-shadow p-6">
          ...
          <div className="flex flex-wrap gap-4 mt-4">
            ...
            <Button variant="outline" size="icon">
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="h-4 w-4"><path d="M12 20V10"/><path d="M18 14l-6-6-6 6"/></svg>
            </Button>
          </div>
        </Card>
      </section>
            ...
            <Card className="shadow-lg hover:shadow-xl transition-shadow p-6">
              ...
              <CardContent className="px-0 space-y-4">
                <div className="space-y-2">
                  ...
                  <Input id="text-input" placeholder="Enter text..." className="shadow hover:shadow-md transition-shadow" />
                </div>
                
                <div className="space-y-2">
                  <Label htmlFor="password-input">Password Input</Label>
                  <Input id="password-input" type="password" placeholder="Enter password..." className="shadow hover:shadow-md transition-shadow" />
                </div>
                
                <div className="space-y-2">
                  <Label htmlFor="textarea">Textarea</Label>
                  <Textarea id="textarea" placeholder="Enter longer text..." className="shadow hover:shadow-md transition-shadow" />
                </div>
              </CardContent>
            </Card>
          </div>
      ...
      <section className="mb-12" id="sanitized-html">
        ...
        <Card className="shadow-lg hover:shadow-xl transition-shadow">
          <CardHeader>
            ...
            <CardDescription>Shows how user-generated HTML content is safely sanitized</CardDescription>
          </CardHeader>
          <CardContent>
            <SanitizedHTML 
              html={`<div>
